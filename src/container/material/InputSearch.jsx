...
export default function EmojiSearch() {
  const [value, setValue] = useState(emoji[2]);
  const [inputValue, setInputValue] = useState("");
 

  const options = emoji.map((option) => {
  ...
  return (
    <>
      ...
      <Autocomplete
        sx={{
          marginLeft: "auto",
          backdropFilter: " blur(2px) saturate(101%)",
          backgroundColor: "rgba(39, 39, 39, 0.18)",
          width: "41%",
          borderRadius: "5px",
      ...
      />
     <Resultbox value={value} inputValue={inputValue} symbol={value.symbol} emoji={value.symbol}/>
    </>
  );
}
